...
~~~
https://github.com/PMelch/MBus.git?path=package#v<version>
~~~

Specify the version you want to install - for example for version 1.3.0 you would use https://github.com/PMelch/MBus.git?path=package#v1.3.0
